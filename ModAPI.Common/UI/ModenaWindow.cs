...
using static ModAPI.Common.NativeMethods;
using static ModAPI.Common.UI.SystemScaling;
...
namespace ModAPI.Common.UI
{
    ...
    public class ModenaWindow : Window
    {
        ...
        public ModenaWindow()
        {
            ...
            try
            {
                dictionary.Source = new Uri(@"pack://application:,,,/ModApi.Common.UI;component/UI/Themes/Modena.xaml");
